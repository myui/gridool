 ...
 */
package gridool.util.pool;

import gridool.util.concurrent.collections.ConcurrentCollectionProvider;
...
public final class ConcurrentKeyedStackObjectPool<K, V> implements Closeable {
    ...
    public ConcurrentKeyedStackObjectPool(String sweepThreadName, PoolableObjectFactory<K, V> factory) {
        ...
        _sweepTimer.scheduleAtFixedRate(new Expirer(factory.getTimeToLive()), 3000, factory.getSweepInterval());
    }
