...
import gridool.util.concurrent.reference.ReferenceMap;
import gridool.util.concurrent.reference.ReferenceType;
...
public abstract class Paged {
    ...
    protected final RandomAccessFile ensureResourceOpen() throws IndexException {
        if(_raf == null) {
            try {
    ...
    public boolean close() throws IndexException {
        if(_opened) {
            this._opened = false;
            // close resources
            try {
    ...
    protected final void checkOpened() throws IndexException {
        if(!_opened) {
            throw new IndexException("Not opened");
        }
    }
     ...
     */
    protected final Page getPage(long pageNum) throws IndexException {
        Page p = null;
     ...
     */
    protected final Page getFreePage() throws IndexException {
        Page p = null;
     ...
     * page number.
     */
    protected final void unlinkPages(long pageNum) throws IndexException {
     ...
     */
    protected final void unlinkPages(Page page) throws IndexException {
        Page nextPage = page;
        if(nextPage != null) {
     ...
     */
    public final void writeValue(Page page, Value value) throws IndexException {
     ...
     * @param value The Value to write
     */
    public final void writeValue(long page, Value value) throws IndexException {
        writeValue(getPage(page), value);
    }

    @Deprecated
    public final long writeValue(Value value) throws IndexException {
        Page p = getFreePage();
        writeValue(p, value);
        return p.getPageNum();
    }
     ...
     * @return The Value
     */
    public final Value readValue(Page page) throws IndexException {
     ...
     */
    @Deprecated
    public final Value readValue(long page) throws IndexException {
    ...
    public final class Page implements Comparable<Page> {
        ...
        public synchronized void write() throws IndexException {
            _pageData.rewind();
