...
import gridool.directory.impl.DefaultLocalDirectory;
import gridool.directory.impl.TcBtreeLocalDirectory;
import gridool.directory.impl.TcHashLocalDirectory;
    ...
    private static ILocalDirectory createLocalDirectory(LockManager lockManager, GridConfiguration config) {
        ...
        switch(type) {
            case tcb:
                ...
                break;
            case tch:
                ld = new TcHashLocalDirectory(lockManager);
                break;
            //case bdb:
            //    ld = new BDBLocalDirectory(lockManager);
            //    break; 
            case bfile:
            default:
