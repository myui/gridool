...
public interface ILocalDirectory {
    ...
    public void set(@Nonnull byte[] key, byte[] value) throws IndexException;

    public byte[] get(@Nonnull byte[] key) throws IndexException;
    ...
    @Nullable
    public byte[][] removeMapping(@Nonnull String idxName, @Nonnull byte[] key)
            throws IndexException;
