    ...
    public GridTaskResultPolicy result(GridTaskResult result) throws GridException {
        ...
        if(err == null) {
            ...
            if(LOG.isWarnEnabled()) {
                LOG.warn("One of Replication of task " + replicatedTask.getClass().getSimpleName()
                        + '[' + result.getTaskId() + "] failed on a node [" + executedNode + ']', err);
            }
            if(replicatedTask.handleNodeFailure()) {
