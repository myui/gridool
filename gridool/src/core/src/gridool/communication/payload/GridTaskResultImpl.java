...
public final class GridTaskResultImpl implements GridTaskResult, Externalizable {
    ...
    public GridTaskResultImpl(@CheckForNull String taskId, @CheckForNull GridNode executedNode, @CheckForNull List<GridNode> replicatedNodes, @Nullable Serializable result, long taskExecTime) {
        if(taskId == null) {
