 ...
 */
public final class DhtReduceJob extends GridJobBase<MapReduceJobConf, String> {
    ...
    public Map<GridTask, GridNode> map(GridTaskRouter router, MapReduceJobConf logic)
