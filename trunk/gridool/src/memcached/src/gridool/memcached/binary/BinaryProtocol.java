...
public final class BinaryProtocol {
    ...
    public enum ResponseStatus {
        NO_ERROR(0x0000), KEY_NOT_FOUND(0x0001), KEY_EXISTS(0x0002), VALUE_TOO_LARGE(0x0003), INVALID_ARGUMENTS(
                0x0004), ITEM_NOT_STORED(0x0005), INCR_OR_DECR_ON_NON_NUMERIC_VALUE(0x0006), VBUCKET_WRONG(
                0x0007), AUTH_ERROR(0x0008), AUTH_CONTINUE(0x0009), UNKNOWN(0x0081), OUT_OF_MEMORY(
                0x0082), NOT_SUPPORTED(0x0083), INTERNAL_ERROR(0x0084), BUSY(0x0085), TEMP_FAILURE(
                0x0086);
