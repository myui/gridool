...
import gridool.dht.job.DirectoryAddRecordJob;
import gridool.dht.job.DirectoryAddRecordJob.AddRecordOps;
 ...
 */
public class DB2DhtMapShuffleTask extends DBMapShuffleTaskBase<DBRecord, DBRecord> {
