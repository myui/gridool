...
public class ConsistentHashTest {
    ...
    @Test
    public void testAdd() {
        int objects = 10000000; //25923;//30000;//10000;
        int numNodes = 64;//10;
        ...
        HashAlgorithm[] algos = new HashAlgorithm[] {
                ...
                HashAlgorithm.FNV1_32_HASH, 
                HashAlgorithm.FNV1A_32_HASH, 
                HashAlgorithm.FNV1_64_HASH, 
                HashAlgorithm.FNV1A_64_HASH,
                /*
                HashAlgorithm.JENKINS_32_HASH,
                HashAlgorithm.JENKINS_64_HASH,
                HashAlgorithm.MURMUR_32_HASH,
                HashAlgorithm.MURMUR_64_HASH,
                HashAlgorithm.PURE_SHA1_HASH, 
                HashAlgorithm.SHA1_HASH,
                HashAlgorithm.MD5_HASH  
                */        
        };
    ...
    private void doTest(int objects, int nodes, int replica, HashAlgorithm algo) {
        ...
        StopWatch sw = new StopWatch("Elapsed time for " + algo);
