...
public final class TimeoutSocketProdiver {
    private static final boolean DISABLE_CUSTOM_SERV_SOCKET = true; //TODO
    private static final int TIMEOUT = Integer.parseInt(Settings.get("gridool.net.socketTimeout", "0"));
