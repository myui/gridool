...
public final class StringUtils {
    ...
    public static String toByteString(final byte[] b) {
        return new String(asChars(b));
    }

    public static String toByteString(final byte[] b, final int offset, final int len) {
        char[] c = asChars(b, offset, len);
        return new String(c, 0, len);
    }

    public static char[] asChars(final byte[] b) {
        return asChars(b, 0, b.length);
    }

    public static char[] asChars(final byte[] b, final int offset, final int len) {
