...
public final class ParallelSQLMapTask extends GridTaskAdapter {
    ...
    private static final boolean DO_WORKAROUND_FOR_COPYINTOFILE = Boolean.parseBoolean(Settings.getThroughSystemProperty("gridool.db.monetdb.workaround.create_tmptbl_for_copyintofile"));
    ...
    protected ParallelSQLMapTaskResult execute() throws GridException {
        ...
        return new ParallelSQLMapTaskResult(taskMasterNode, sentFileName, taskNumber, fetchedRows, queryExecTime, sendResultTime);
    }
    ...
    static final class ParallelSQLMapTaskResult implements Externalizable {
        ...
        ParallelSQLMapTaskResult(@Nonnull GridNode masterNode, @Nullable String fileName, int taskNumber, int numRows, long queryExecTime, long sendResultTime) {
