...
public class DhtMapJob extends GridJobBase<byte[], String> {
    ...
    protected transient MapReduceJobConf logicControl;
    ...
    public final Map<GridTask, GridNode> map(GridTaskRouter router, byte[] rawLogic)
            throws GridException {
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        MapReduceJobConf logic = ObjectUtils.readObjectQuietly(rawLogic, cl);
