 ...
 */
public final class UpdateCatalogJob extends GridJobBase<UpdateCatalogJob.JobConf, Boolean> {
    private static final long serialVersionUID = -4173733362983065008L;
    private static final Log LOG = LogFactory.getLog(UpdateCatalogJob.class);
    ...
    public Map<GridTask, GridNode> map(final GridTaskRouter router, final JobConf jobConf)
        ...
        for(final GridNode node : nodes) {
            GridTask task = new UpdateCatalogTask(this, jobConf);
            map.put(task, node);
        }
        return map;
    }
    ...
    private static final class UpdateCatalogTask extends GridTaskAdapter {
        ...
        protected UpdateCatalogTask(GridJob job, JobConf jobConf) {
            super(job, false);
