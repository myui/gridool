...
public class DbCountInitializeJob extends GridJobBase<DBMapReduceJobConf, Long> {
	...
	private static final Log LOG = LogFactory
			.getLog(DbCountInitializeJob.class);
	...
	public Map<GridTask, GridNode> map(final GridTaskRouter router,
			final DBMapReduceJobConf jobConf) throws GridException {
	...
	private int initialize(DBMapReduceJobConf jobConf)
	...
	private int populateAccess(final Connection conn) throws SQLException {
		...
		// Pages in the site :
		final String[] pages = { "/a", "/b", "/c", "/d", "/e", "/f", "/g",
				"/h", "/i", "/j" };
		// linkMatrix[i] is the array of pages(indexes) that page_i links to.
		final int[][] linkMatrix = { { 1, 5, 7 }, { 0, 7, 4, 6, },
				{ 0, 1, 7, 8 }, { 0, 2, 4, 6, 7, 9 }, { 0, 1 }, { 0, 3, 5, 9 },
				{ 0 }, { 0, 1, 3 }, { 0, 2, 6 }, { 0, 2, 6 } };
