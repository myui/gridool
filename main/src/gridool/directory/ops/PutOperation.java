...
import xbird.util.collections.ImmutableArrayList;
 ...
 */
@NotThreadSafe
public final class PutOperation implements DirectoryOperation {
    ...
    public PutOperation() {}//for Externalizable

    public PutOperation(@Nonnull String idxName) {
        this.idxName = idxName;
        this.keys = new ArrayList<byte[]>(4);
        this.values = new ArrayList<byte[]>(4);
    }

    public PutOperation(@Nonnull byte[] key, @Nonnull byte[] value) {
        this(ILocalDirectory.DEFAULT_IDX_NAME, key, value);
    }

    public PutOperation(@Nonnull String idxName, @Nonnull byte[] key, @Nonnull byte[] value) {
        this.idxName = idxName;
        this.keys = new ArrayList<byte[]>(4);
        this.values = new ArrayList<byte[]>(4);
        keys.add(key);
     ...
     */
    public PutOperation(@Nonnull String idxName, @Nonnull byte[][] keys, @Nonnull byte[][] values) {
        this.idxName = idxName;
        this.keys = Arrays.asList(keys);
        this.values = Arrays.asList(values);
    }

    public PutOperation(@Nonnull String idxName, @Nonnull List<byte[]> keys, @Nonnull List<byte[]> values) {
        this.idxName = idxName;
        this.keys = keys;
        this.values = values;
    }
    ...
    public PutOperation makeOperation(List<byte[]> keys, List<byte[]> values) {
        return new PutOperation(idxName, keys, values);
    }
