 ...
 */
public final class PrependOperation<T extends Serializable> extends KeyValueOperation<T> {
    private static final long serialVersionUID = 1743877704485257143L;

    public PrependOperation(String key, T value, boolean async) {
        super(key, value, async);
    }

    @Override
    public MemcachedOps getOperationType() {
        return MemcachedOps.prepend;
    }
